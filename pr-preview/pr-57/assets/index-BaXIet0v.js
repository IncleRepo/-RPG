...
5. 백야의 대사는 항상 정답을 직접 말하지 않고,
   미래형, 회상형, 은유형 표현으로 반 박자 늦게 꽂히게 쓴다.
6. 각 장면 끝에는 다음 탐험 목표가 한 문장으로 선명하게 남아야 한다.
...
- 차분하고 정리된 문장
- 감정을 숨기지만 특정 대상, 특히 가족과 새벽종 이야기가 나오면 미세하게 호흡이 흔들림
- 예시 어조: "정황을 먼저 맞추자.", "확신은 없어도 가능성은 충분해.", "이번엔 놓치지 않을 거야."
...
- 등장인물: 플레이어, 사야 렌, 라오 템, 유라 베인
- 스크립트:
- 환영 속 사야 렌: "언니, 이번엔 늦지 않았어. 항로도, 기록도, 새벽도 전부 제자리에 돌아왔어."
- 플레이어: "사야, 이건 네가 원하는 내일이야?"
- 사야 렌: "원했다기보다 버리지 못한 내일이지."
...
- 사야 렌: "미워할 수도 있을 것 같았는데... 아직은 모르겠어."
