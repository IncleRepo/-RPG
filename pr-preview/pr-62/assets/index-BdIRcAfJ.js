...
`,h=Object.freeze({title:"반향해 연대기",subtitle:"내일이 결정으로 떠오르는 세계에서, 사라진 새벽을 추적하는 해양 판타지 RPG 설정집",pitch:"플레이어는 미래의 잔향을 들을 수 있는 여명 인양사가 되어, 도시 국가와 고대 장치가 얽힌 세계에서 내일의 소유권을 둘러싼 전쟁을 마주한다.",setting:"반향해 기반 해양 판타지",mood:"몽환적 서정성과 시간 재난",coreConflict:"미래를 통제할 것인가, 모두에게 되돌릴 것인가"}),G=Object.freeze([{label:"세계 키워드",value:"반향해, 내일결, 새벽종"},{label:"플레이어 역할",value:"미래 반향을 듣는 여명 인양사"},{label:"메인 목표",value:"일곱 개의 새벽 종편 회수"},{label:"메인 플레이타임",value:"약 8시간"},{label:"문서 구성",value:"시나리오 6종 + 인물 외형 메모"},{label:"서사 테마",value:"강한 미래는 누군가의 가능성을 앗아간다"}]),z=Object.freeze([{title:"미래를 자원처럼 쓰는 세계",text:"전투와 탐험, 정치가 모두 내일결 배분 구조와 연결된다."},{title:"상실을 전제로 한 성장",text:"강력한 힘은 기억, 관계, 현재 감각을 대가로 요구한다."},{title:"항해형 지역 구조",text:"도시와 던전이 조류와 시간대에 따라 다른 규칙을 가진다."}]),T=Object.freeze([{era:"첫 역조",detail:"하늘과 바다의 경계가 뒤집히고 반향해가 생겨난다."},{era:"새벽종 시대",detail:"고대인들이 미래 배급 장치를 만들고 문명을 안정시킨다."},{era:"무월조 발발",detail:"내일결 생성이 멈추고 일부 지역에서 아침이 사라진다."},{era:"플레이어의 항해",detail:"종편 회수와 세계 질서 재구성의 선택이 시작된다."}]),u=Object.freeze([{id:"story-overview",title:"스토리 개요",category:"메인 설정",summary:"세계의 한 줄 콘셉트, 플레이어 역할, 메인 목표를 빠르게 파악하는 문서",fileName:"src/content/lore/story-overview.md",accent:"teal",content:j},{id:"main-story",title:"메인 스토리",category:"메인 설정",summary:"프롤로그부터 엔딩 선택까지의 3막 구조와 핵심 반전을 정리한 문서",fileName:"src/content/lore/main-story.md",accent:"gold",content:P},{id:"scenario-overview",title:"시나리오 개요",category:"시나리오 설계",summary:"메인 엔딩까지 약 8시간 기준의 챕터 수, 플레이타임, 대사 스크립트 작성 원칙을 정리한 문서",fileName:"src/content/scenario/00-overview.md",accent:"teal",content:L},{id:"scenario-prologue",title:"프롤로그",category:"챕터 시나리오",summary:"미라진에서 사라진 새벽을 목격하고 첫 항해를 시작하는 도입 챕터와 상세 대사 문서",fileName:"src/content/scenario/01-prologue.md",accent:"coral",content:A},{id:"scenario-chapter-1",title:"챕터 1",category:"챕터 시나리오",summary:"유리염 사구에서 생존 갈등을 체감하고 첫 두 개의 종편을 회수하는 장면별 스크립트 문서",fileName:"src/content/scenario/02-chapter-1.md",accent:"gold",content:M},{id:"scenario-chapter-2",title:"챕터 2",category:"챕터 시나리오",summary:"역항도 카델에서 유라 베인의 질서 논리와 두 개의 종편을 마주하는 장면별 스크립트 문서",fileName:"src/content/scenario/03-chapter-2.md",accent:"plum",content:O},{id:"scenario-chapter-3",title:"챕터 3",category:"챕터 시나리오",summary:"속삭임 과수원과 척추탑에서 진실과 플레이어 정체성을 드러내는 장면별 스크립트 문서",fileName:"src/content/scenario/04-chapter-3.md",accent:"slate",content:C},{id:"scenario-ending",title:"엔딩",category:"챕터 시나리오",summary:"침묵 산호궁 최종 던전과 세 가지 메인 엔딩 선택을 상세 스크립트로 정리한 문서",fileName:"src/content/scenario/05-ending.md",accent:"rose",content:D},{id:"bgm-plan",title:"BGM 설계안",category:"오디오 기획",summary:"시나리오와 세계관 문서를 기반으로 장면별 필요 음악과 트랙 매핑을 정리한 문서",fileName:"src/content/audio/bgm-plan.md",accent:"gold",content:q},{id:"bgm-production-notes",title:"BGM 제작 메모",category:"오디오 제작",summary:"생성 도구, 자산 구조, 재생산 명령, 운용 메모를 정리한 문서",fileName:"src/content/audio/bgm-production-notes.md",accent:"teal",content:S},{id:"world-rules",title:"세계 규칙",category:"시스템 설정",summary:"반향해, 내일결, 시간 균열, 여명 인양사의 규칙을 정의한 문서",fileName:"src/content/lore/world-rules.md",accent:"coral",content:B},{id:"regions",title:"지역 설정",category:"세부 설정",summary:"항구, 사막, 역중력 도시, 최종 던전 등 탐험 지역의 성격을 정리한 문서",fileName:"src/content/lore/regions.md",accent:"plum",content:H},{id:"factions",title:"세력 설정",category:"세부 설정",summary:"조율원, 염해 길드, 공백 법정 등 주요 집단의 논리와 강약점을 정의한 문서",fileName:"src/content/lore/factions.md",accent:"slate",content:I},{id:"characters",title:"인물 설정",category:"세부 설정",summary:"플레이어와 주요 인물의 역할, 감정선, 외형 디자인 포인트를 정리한 문서",fileName:"src/content/lore/characters.md",accent:"rose",content:E}]),N=document.querySelector("#app");if(!N)throw new Error("앱 루트 요소를 찾을 수 없습니다.");const x=Object.freeze(["bgm-plan","scenario-overview","scenario-prologue","scenario-chapter-1","scenario-chapter-2","scenario-chapter-3","scenario-ending","bgm-production-notes"]),_=Object.freeze(x.map(n=>u.find(e=>e.id===n)).filter(Boolean));function f(n){return u.find(e=>e.id===n)}function $(){const n=decodeURIComponent(window.location.hash.replace(/^#/,""));return f(n)?n:""}function k(n){const e=`#${n}`;window.location.hash!==e&&window.history.replaceState(null,"",e)}function F(n){return n.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function m(n){return F(n).replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>")}function R(n){const e=n.trim().split(/\r?\n/),o=[];let t=[],a=[],r="ul",s=[];const i=()=>{t.length&&(o.push(`<p>${t.map(m).join("<br />")}</p>`),t=[])},l=()=>{if(!a.length)return;const g=a.map(c=>`<li>${m(c)}</li>`).join("");o.push(`<${r}>${g}</${r}>`),a=[],r="ul"},d=()=>{s.length&&(o.push(`<blockquote><p>${s.map(m).join("<br />")}</p></blockquote>`),s=[])};for(const g of e){const c=g.trimEnd(),p=c.match(/^(#{1,3})\s+(.*)$/),y=c.match(/^-\s+(.*)$/),v=c.match(/^\d+\.\s+(.*)$/),b=c.match(/^>\s?(.*)$/);if(!c.trim()){i(),l(),d();continue}if(c==="---"){i(),l(),d(),o.push("<hr />");continue}if(p){i(),l(),d();const w=p[1].length;o.push(`<h${w}>${m(p[2])}</h${w}>`);continue}if(y){i(),d(),r!=="ul"&&a.length&&l(),r="ul",a.push(y[1]);continue}if(v){i(),d(),r!=="ol"&&a.length&&l(),r="ol",a.push(v[1]);continue}if(b){i(),l(),s.push(b[1]);continue}t.push(c)}return i(),l(),d(),o.join("")}function U(n,e){const o=document.querySelector("[data-document-nav]");o&&(o.innerHTML=u.map(t=>`
        <button
          type="button"
      ...
      `).join(""),o.querySelectorAll("[data-document-trigger]").forEach(t=>{t.addEventListener("click",()=>{e(t.getAttribute("data-document-trigger")||n)})}))}function V(n,e){const o=document.querySelector("[data-featured-links]");o&&(o.innerHTML=_.map(t=>`
        <button
          type="button"
      ...
      `).join(""),o.querySelectorAll("[data-featured-trigger]").forEach(t=>{t.addEventListener("click",()=>{e(t.getAttribute("data-featured-trigger")||n)})}))}function W(n){const e=f(n)??u[0],o=document.querySelector("[data-document-viewer]");!o||!e||(o.innerHTML=`
  ...
  `}function Q(){let n=$()||_[0]?.id||u[0]?.id||"";const e=(o,{syncHash:t=!0}={})=>{n=f(o)?.id??n,V(n,e),U(n,e),W(n),t&&k(n)};K(),e(n),window.addEventListener("hashchange",()=>{const o=$();o&&o!==n&&e(o,{syncHash:!1})})}Q();
