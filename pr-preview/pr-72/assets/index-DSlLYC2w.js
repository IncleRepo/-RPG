...
`,f=Object.freeze({title:"반향해 연대기",subtitle:"내일이 결정으로 떠오르는 세계에서, 사라진 새벽을 추적하는 해양 판타지 RPG 설정집",pitch:"플레이어는 미래의 잔향을 들을 수 있는 여명 인양사가 되어, 도시 국가와 고대 장치가 얽힌 세계에서 내일의 소유권을 둘러싼 전쟁을 마주한다.",setting:"반향해 기반 해양 판타지",mood:"몽환적 서정성과 시간 재난",coreConflict:"미래를 통제할 것인가, 모두에게 되돌릴 것인가"}),X=Object.freeze([{label:"세계 키워드",value:"반향해, 내일결, 새벽종"},{label:"플레이어 역할",value:"미래 반향을 듣는 여명 인양사"},{label:"메인 목표",value:"일곱 개의 새벽 종편 회수"},{label:"메인 플레이타임",value:"약 8시간"},{label:"문서 구성",value:"시나리오 6종 + 설정/설계 8종 + BGM 설계 1종"},{label:"서사 테마",value:"강한 미래는 누군가의 가능성을 앗아간다"}]),Y=Object.freeze([{title:"미래를 자원처럼 쓰는 세계",text:"전투와 탐험, 정치가 모두 내일결 배분 구조와 연결된다."},{title:"상실을 전제로 한 성장",text:"강력한 힘은 기억, 관계, 현재 감각을 대가로 요구한다."},{title:"항해형 지역 구조",text:"도시와 던전이 조류와 시간대에 따라 다른 규칙을 가진다."}]),Z=Object.freeze([{era:"첫 역조",detail:"하늘과 바다의 경계가 뒤집히고 반향해가 생겨난다."},{era:"새벽종 시대",detail:"고대인들이 미래 배급 장치를 만들고 문명을 안정시킨다."},{era:"무월조 발발",detail:"내일결 생성이 멈추고 일부 지역에서 아침이 사라진다."},{era:"플레이어의 항해",detail:"종편 회수와 세계 질서 재구성의 선택이 시작된다."}]),u=Object.freeze([{id:"story-overview",title:"스토리 개요",category:"메인 설정",summary:"세계의 한 줄 콘셉트, 플레이어 역할, 메인 목표를 빠르게 파악하는 문서",fileName:"src/content/lore/story-overview.md",accent:"teal",content:B},{id:"main-story",title:"메인 스토리",category:"메인 설정",summary:"프롤로그부터 엔딩 선택까지의 3막 구조와 핵심 반전을 정리한 문서",fileName:"src/content/lore/main-story.md",accent:"gold",content:j},{id:"core-systems",title:"코어 게임 시스템 설계",category:"시스템 설계",summary:"이동, 전투, 자원, 성장, 세이브, 실패 패널티를 포함한 실제 구현 기준의 코어 시스템 설계 문서",fileName:"src/content/game-design/00-core-systems.md",accent:"slate",content:A},{id:"prologue-playflow",title:"프롤로그 플레이 구성",category:"플레이 설계",summary:"프롤로그를 실제 구현 가능한 구간 단위로 재구성해 맵 흐름, 조사, 대화, 전투, 연출, UI 요구사항을 정리한 문서",fileName:"src/content/game-design/01-prologue-playflow.md",accent:"coral",content:M},{id:"audio-scenario-plan",title:"시나리오 기반 BGM 설계안",category:"오디오 설계",summary:"챕터와 장면 감정선에 맞춘 핵심 BGM 8곡의 용도, 분위기, 배치 기준을 정리한 문서",fileName:"src/content/audio/00-scenario-bgm-plan.md",accent:"gold",content:K},{id:"scenario-overview",title:"시나리오 개요",category:"시나리오 설계",summary:"메인 엔딩까지 약 8시간 기준의 챕터 수, 플레이타임, 대사 스크립트 작성 원칙을 정리한 문서",fileName:"src/content/scenario/00-overview.md",accent:"teal",content:G},{id:"scenario-prologue",title:"프롤로그",category:"챕터 시나리오",summary:"미라진에서 사라진 새벽을 목격하고 첫 항해를 시작하는 도입 챕터와 상세 대사 문서",fileName:"src/content/scenario/01-prologue.md",accent:"coral",content:E},{id:"scenario-chapter-1",title:"챕터 1",category:"챕터 시나리오",summary:"유리염 사구에서 생존 갈등을 체감하고 첫 두 개의 종편을 회수하는 장면별 스크립트 문서",fileName:"src/content/scenario/02-chapter-1.md",accent:"gold",content:q},{id:"scenario-chapter-2",title:"챕터 2",category:"챕터 시나리오",summary:"역항도 카델에서 유라 베인의 질서 논리와 두 개의 종편을 마주하는 장면별 스크립트 문서",fileName:"src/content/scenario/03-chapter-2.md",accent:"plum",content:F},{id:"scenario-chapter-3",title:"챕터 3",category:"챕터 시나리오",summary:"속삭임 과수원과 척추탑에서 진실과 플레이어 정체성을 드러내는 장면별 스크립트 문서",fileName:"src/content/scenario/04-chapter-3.md",accent:"slate",content:z},{id:"scenario-ending",title:"엔딩",category:"챕터 시나리오",summary:"침묵 산호궁 최종 던전과 세 가지 메인 엔딩 선택을 상세 스크립트로 정리한 문서",fileName:"src/content/scenario/05-ending.md",accent:"rose",content:x},{id:"world-rules",title:"세계 규칙",category:"시스템 설정",summary:"반향해, 내일결, 시간 균열, 여명 인양사의 규칙을 정의한 문서",fileName:"src/content/lore/world-rules.md",accent:"coral",content:W},{id:"regions",title:"지역 설정",category:"세부 설정",summary:"항구, 사막, 역중력 도시, 최종 던전 등 탐험 지역의 성격을 정리한 문서",fileName:"src/content/lore/regions.md",accent:"plum",content:V},{id:"factions",title:"세력 설정",category:"세부 설정",summary:"조율원, 염해 길드, 공백 법정 등 주요 집단의 논리와 강약점을 정의한 문서",fileName:"src/content/lore/factions.md",accent:"slate",content:J},{id:"characters",title:"인물 설정",category:"세부 설정",summary:"플레이어와 주요 인물의 역할, 감정선, 외형 디자인 포인트를 정리한 문서",fileName:"src/content/lore/characters.md",accent:"rose",content:Q}]),N=document.querySelector("#app");if(!N)throw new Error("앱 루트 요소를 찾을 수 없습니다.");const nn=Object.freeze(["core-systems","audio-scenario-plan","scenario-overview","scenario-prologue","scenario-chapter-1","scenario-chapter-2","scenario-chapter-3","scenario-ending","characters"]),C=Object.freeze(nn.map(e=>u.find(t=>t.id===e)).filter(Boolean));function v(e){return u.find(t=>t.id===e)}function $(){const e=decodeURIComponent(window.location.hash.replace(/^#/,""));return v(e)?e:""}function en(e){const t=`#${e}`;window.location.hash!==t&&window.history.replaceState(null,"",t)}function tn(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function m(e){return tn(e).replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>")}function an(e){const t=e.trim().split(/\r?\n/),a=[];let n=[],s=[],r="ul",c=[];const i=()=>{n.length&&(a.push(`<p>${n.map(m).join("<br />")}</p>`),n=[])},l=()=>{if(!s.length)return;const h=s.map(o=>`<li>${m(o)}</li>`).join("");a.push(`<${r}>${h}</${r}>`),s=[],r="ul"},d=()=>{c.length&&(a.push(`<blockquote><p>${c.map(m).join("<br />")}</p></blockquote>`),c=[])};for(const h of t){const o=h.trimEnd(),g=o.match(/^(#{1,3})\s+(.*)$/),P=o.match(/^-\s+(.*)$/),b=o.match(/^\d+\.\s+(.*)$/),w=o.match(/^>\s?(.*)$/);if(!o.trim()){i(),l(),d();continue}if(o==="---"){i(),l(),d(),a.push("<hr />");continue}if(g){i(),l(),d();const _=g[1].length;a.push(`<h${_}>${m(g[2])}</h${_}>`);continue}if(P){i(),d(),r!=="ul"&&s.length&&l(),r="ul",s.push(P[1]);continue}if(b){i(),d(),r!=="ol"&&s.length&&l(),r="ol",s.push(b[1]);continue}if(w){i(),l(),c.push(w[1]);continue}n.push(o)}return i(),l(),d(),a.join("")}function rn(e,t){const a=document.querySelector("[data-document-nav]");a&&(a.innerHTML=u.map(n=>`
        <button
          type="button"
      ...
      `).join(""),a.querySelectorAll("[data-document-trigger]").forEach(n=>{n.addEventListener("click",()=>{t(n.getAttribute("data-document-trigger")||e)})}))}function sn(e,t){const a=document.querySelector("[data-featured-links]");a&&(a.innerHTML=C.map(n=>`
        <button
          type="button"
      ...
      `).join(""),a.querySelectorAll("[data-featured-trigger]").forEach(n=>{n.addEventListener("click",()=>{t(n.getAttribute("data-featured-trigger")||e)})}))}function cn(e){const t=v(e)??u[0],a=document.querySelector("[data-document-viewer]");!a||!t||(a.innerHTML=`
    ...
    <article class="markdown-body">${an(t.content)}</article>
  `)}function on(){return{activeTrackId:p[0]?.id??"",isPlaying:!1}}function y(e){return p.find(t=>t.id===e)}function I(e){const t=document.querySelector("[data-soundtrack-player]"),a=document.querySelector("[data-soundtrack-element]"),n=y(e.activeTrackId)??p[0];!t||!a||!n||(t.innerHTML=`
  ...
  `,a.setAttribute("aria-label",`${n.koreanTitle} 재생기`))}function k(e){const t=document.querySelector("[data-soundtrack-list]");t&&(t.innerHTML=p.map(a=>`
  ...
  `}function dn(){let e=$()||C[0]?.id||u[0]?.id||"";const t=on(),a=(r,{syncHash:c=!0}={})=>{e=v(r)?.id??e,sn(e,a),rn(e,a),cn(e),c&&en(e)};ln();const n=document.querySelector("[data-soundtrack-element]");a(e),I(t),k(t);const s=()=>{I(t),k(t),document.querySelectorAll("[data-audio-toggle]").forEach(r=>{r.addEventListener("click",async()=>{const c=r.getAttribute("data-audio-toggle"),i=y(c);if(!(!n||!i))if(t.activeTrackId!==i.id&&(n.src=i.src,n.dataset.trackId=i.id,t.activeTrackId=i.id),n.paused)try{await n.play()}catch{t.isPlaying=!1,s()}else if(n.dataset.trackId===i.id)n.pause();else{n.pause(),n.src=i.src,n.dataset.trackId=i.id;try{await n.play()}catch{t.isPlaying=!1,s()}}})})};if(n){const r=y(t.activeTrackId);r&&(n.src=r.src,n.dataset.trackId=r.id),n.addEventListener("play",()=>{t.isPlaying=!0,t.activeTrackId=n.dataset.trackId||t.activeTrackId,s()}),n.addEventListener("pause",()=>{t.isPlaying=!1,s()}),n.addEventListener("ended",()=>{t.isPlaying=!1,s()})}s(),window.addEventListener("hashchange",()=>{const r=$();r&&r!==e&&a(r,{syncHash:!1})})}dn();
