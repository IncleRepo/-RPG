(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function r(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(t){if(t.ep)return;t.ep=!0;const s=r(t);fetch(t.href,s)}})();const H=""+new URL("01-tides-of-the-unarrived-dawn-s_Ku7bdq.mp3",import.meta.url).href,k=""+new URL("02-twilight-over-mirajin-Bp0rsTe1.mp3",import.meta.url).href,O=""+new URL("03-saltglass-horizon-DWtSCHK_.mp3",import.meta.url).href,N=""+new URL("04-inverted-harbor-of-kadel-C4m1LfRM.mp3",import.meta.url).href,Q=""+new URL("05-fracture-chase-CD2c6Hvv.mp3",import.meta.url).href,E=""+new URL("06-bellshard-skirmish-_gbuKm7S.mp3",import.meta.url).href,L=""+new URL("07-whispers-beneath-the-orchard-C9gNFPhc.mp3",import.meta.url).href,R=""+new URL("08-abyssal-choir-reborn-dIGgSxeB.mp3",import.meta.url).href,m=Object.freeze([{id:"main-theme",title:"Tides Of The Unarrived Dawn",koreanTitle:"반향해 연대기 메인 테마",category:"타이틀 / 메인 테마",accent:"gold",durationLabel:"1:50",chapters:"전체 공통",sceneUse:"타이틀, 핵심 컷신 회고, 메인 메뉴 대표곡",mood:"장엄한 바다 판타지, 비터스위트한 상실, 앞으로 나아가야 하는 의지",instrumentation:"현악, 피아노, 호른, 유리 질감 벨, 깊은 저역 퍼커션",summary:"세계관의 규모감과 플레이어의 책임감을 동시에 들려주는 대표 테마입니다.",src:H,fileName:"assets/audio/01-tides-of-the-unarrived-dawn.mp3"},{id:"mirajin-hub",title:"Twilight Over Mirajin",koreanTitle:"미라진 황혼 허브",category:"마을 / 허브 지역",accent:"coral",durationLabel:"2:40",chapters:"프롤로그",sceneUse:"항구 조사, 출항 전 대화, 미라진 탐색",mood:"사라진 새벽의 정적, 조용한 죄책감, 아직 남아 있는 희망",instrumentation:"펠트 피아노, 저목관, 부드러운 현, 먼 종소리",summary:"영원한 황혼에 잠긴 항구의 쓸쓸함을 허브 탐색에 맞는 밀도로 정리한 곡입니다.",src:k,fileName:"assets/audio/02-twilight-over-mirajin.mp3"},{id:"glass-salt-exploration",title:"Saltglass Horizon",koreanTitle:"유리염 사구 탐험",category:"탐험",accent:"teal",durationLabel:"3:14",chapters:"챕터 1",sceneUse:"사구 필드 이동, 폐채굴 첨탑 전 탐험, 구조 동선 이동",mood:"황량함, 생존감, 묻힌 기억의 메아리, 넓은 수평선",instrumentation:"공기감 있는 현, 부드러운 타악, 유리성 타건, 낮은 첼로",summary:"미래가 메마른 땅의 공허함과 탐험 리듬을 함께 살리는 메인 필드 테마입니다.",src:O,fileName:"assets/audio/03-saltglass-horizon.mp3"},{id:"kadel-city",title:"Inverted Harbor Of Kadel",koreanTitle:"역항도 카델",category:"도시 / 정치 긴장",accent:"plum",durationLabel:"4:05",chapters:"챕터 2",sceneUse:"카델 진입, 도시 조사, 협상 이후 이동 구간",mood:"우아한 압박감, 불안한 균형, 규율의 아름다움과 냉기",instrumentation:"말렛 오스티나토, 절제된 브라스, 정교한 현, 기계 펄스",summary:"질서로 떠받친 도시의 위압감을 과도한 소음 없이 유지하도록 설계한 곡입니다.",src:N,fileName:"assets/audio/04-inverted-harbor-of-kadel.mp3"},{id:"crisis-pursuit",title:"Fracture Chase",koreanTitle:"붕괴 추적과 긴장",category:"긴장 / 추적",accent:"slate",durationLabel:"3:20",chapters:"프롤로그, 챕터 1, 챕터 2, 엔딩",sceneUse:"시계탑 탈출, 구조전 직전, 카델 붕괴, 산호궁 붕괴 구간",mood:"급박한 이동, 무너지는 구조물, 사람을 먼저 구해야 하는 압력",instrumentation:"빠른 현 리듬, 깊은 탐, 절제된 신스 펄스, 짧은 금관 액센트",summary:"추격과 재난 상황에서 긴장을 끌어올리되 피로한 자극음으로 흐르지 않게 조정한 액션 트랙입니다.",src:Q,fileName:"assets/audio/05-fracture-chase.mp3"},{id:"battle-skirmish",title:"Bellshard Skirmish",koreanTitle:"일반 전투",category:"전투",accent:"rose",durationLabel:"2:52",chapters:"전 챕터 공통",sceneUse:"일반 전투, 균열 생물 교전, 중간 보스 전 전반",mood:"전투 추진력, 영웅성, 비극의 그림자가 남아 있는 긴장감",instrumentation:"리듬 현, 브라스, 저역 타격, 어두운 드론",summary:"스토리 중심 RPG에 맞춰 추진력은 확보하되 과도한 공격성은 피한 공용 전투 곡입니다.",src:E,fileName:"assets/audio/06-bellshard-skirmish.mp3"},{id:"orchard-revelation",title:"Whispers Beneath The Orchard",koreanTitle:"감정 이벤트와 진실",category:"감정 이벤트",accent:"teal",durationLabel:"3:05",chapters:"챕터 3",sceneUse:"속삭임 과수원, 사야 렌 고백, 척추탑 진실 공개",mood:"친밀감, 후회, 신뢰, 돌이킬 수 없는 진실의 무게",instrumentation:"피아노, 솔로 첼로, 하프, 유리 하모닉, 숨 쉬는 듯한 현",summary:"관계와 진실이 동시에 무너져 내리는 장면을 위해 설계한 감정 축 중심 테마입니다.",src:L,fileName:"assets/audio/07-whispers-beneath-the-orchard.mp3"},{id:"boss-ending",title:"Abyssal Choir Reborn",koreanTitle:"최종 결전과 엔딩",category:"보스전 / 엔딩",accent:"gold",durationLabel:"3:05",chapters:"엔딩",sceneUse:"심연의 합창기 보스전, 마지막 선택, 엔딩 크레딧",mood:"압도적 결전, 세계의 무게, 비터스위트한 새벽과 후일담",instrumentation:"거대한 저현, 브라스, 깊은 종소리, 피아노, 열리는 현 합주",summary:"최종 보스전의 중압감에서 엔딩의 여운까지 한 곡 안에서 아우르는 대서사 트랙입니다.",src:R,fileName:"assets/audio/08-abyssal-choir-reborn.mp3"}]),S="data:image/png;base64,",G="data:image/png;base64,",M="data:image/png;base64,",T="data:image/png;base64,",_="data:image/png;base64,",F="data:image/png;base64,",j=""+new URL("prologue-player-review-400-C1NGd2Y5.png",import.meta.url).href,z=""+new URL("prologue-player-preview-light-f_3WTM6X.png",import.meta.url).href,K=""+new URL("prologue-player-preview-dark-BjQEWSea.png",import.meta.url).href,c=Object.freeze({eyebrow:"Issue #80 · Prologue Player Art",title:"프롤로그 플레이어 마스터 스프라이트 확정안",summary:"정지 기본 포즈 3안 중 B안을 마스터 스프라이트로 확정하고, 같은 비례를 유지한 idle 키포즈와 720p 검수 이미지를 함께 제출합니다.",decision:{selectedLabel:"마스터 스프라이트: B안",canvas:"기본 캔버스 32 x 48 px",review:"100%, 400%, 밝은 배경, 어두운 배경, 720p 검수 완료"},rationale:Object.freeze(["얼굴 중앙 2px 눈선과 피부 하이라이트를 먼저 읽히게 정리해 의상보다 인물이 먼저 보이도록 고정했습니다.","머리, 얼굴, 목, 상의가 단일 청색 덩어리로 겹치지 않도록 머리와 피부, 상의 명도 차를 크게 벌렸습니다.","외투 자락은 허벅지 중간에서 끊어 다리 실루엣과 보행 축이 100% 보기에서도 유지되게 설계했습니다."]),poseOptions:Object.freeze([{label:"안 A",image:S,note:"왼손 랜턴과 전방 기울기를 강조한 탐색형 정지 포즈입니다."},{label:"안 B · 확정",image:G,note:"정면 축, 얼굴 가독성, 상하체 분리가 가장 안정적이어서 마스터 스프라이트로 채택했습니다."},{label:"안 C",image:M,note:"허리 장비와 비대칭 무게중심을 더 강하게 준 현장형 포즈입니다."}]),deliverables:Object.freeze([{label:"마스터 스프라이트",image:T,note:"얼굴과 목선을 먼저 읽히게 정리한 최종 1종입니다."},{label:"Idle 키포즈",image:_,note:"상체 호흡, 시선 이동, 미세한 체중 변화를 4프레임 키포즈로 정리했습니다."},{label:"100% 검수 시트",image:F,note:"작은 크기에서 얼굴, 코트, 다리 분리 기준을 확인하는 시트입니다."},{label:"400% 검수 시트",image:j,note:"확대 시 픽셀 클러스터와 머리-피부-의상 경계를 확인하는 시트입니다."},{label:"밝은 배경 720p 프리뷰",image:z,note:"밝은 부두 배경 위에서 실루엣과 피부색 분리를 확인합니다."},{label:"어두운 배경 720p 프리뷰",image:K,note:"야간 배경 위에서 외곽과 얼굴 포인트 유지 여부를 확인합니다."}]),palette:Object.freeze([{name:"Hair Shadow",hex:"#30445f",role:"머리 외곽과 실루엣 고정"},{name:"Hair Mid",hex:"#4f698c",role:"머리 덩어리 분리"},{name:"Hair Light",hex:"#7b93b3",role:"앞머리 하이라이트"},{name:"Skin Shadow",hex:"#aa7458",role:"턱선과 목선 분리"},{name:"Skin Base",hex:"#d89a74",role:"얼굴 기본색"},{name:"Skin Light",hex:"#f0c3a1",role:"이마와 광대 하이라이트"},{name:"Coat Dark",hex:"#1c4b63",role:"외투 실루엣 고정"},{name:"Coat Base",hex:"#2f6d84",role:"젖은 남청 외투 기본색"},{name:"Coat Light",hex:"#4c97ac",role:"몸통 면 분리"},{name:"Shirt",hex:"#9fb8bf",role:"목 아래 상의 구분"},{name:"Pants Dark",hex:"#39475f",role:"하체 암부"},{name:"Pants Base",hex:"#556783",role:"하체 기본색"},{name:"Pants Light",hex:"#7185a3",role:"무릎과 허벅지 면 분리"},{name:"Leather",hex:"#9b6a4c",role:"장비 벨트와 소지품 포인트"},{name:"Glow",hex:"#f5cf74",role:"이어피스와 새벽빛 악센트"}])}),Y=`# 반향해 연대기
...
`,P=Object.freeze({title:"반향해 연대기",subtitle:"내일이 결정으로 떠오르는 세계에서, 사라진 새벽을 추적하는 해양 판타지 RPG 설정집",pitch:"플레이어는 미래의 잔향을 들을 수 있는 여명 인양사가 되어, 도시 국가와 고대 장치가 얽힌 세계에서 내일의 소유권을 둘러싼 전쟁을 마주한다.",setting:"반향해 기반 해양 판타지",mood:"몽환적 서정성과 시간 재난",coreConflict:"미래를 통제할 것인가, 모두에게 되돌릴 것인가"}),dn=Object.freeze([{label:"세계 키워드",value:"반향해, 내일결, 새벽종"},{label:"플레이어 역할",value:"미래 반향을 듣는 여명 인양사"},{label:"메인 목표",value:"일곱 개의 새벽 종편 회수"},{label:"메인 플레이타임",value:"약 8시간"},{label:"문서 구성",value:"시나리오 6종 + 설정/설계 10종 + BGM 설계 1종"},{label:"서사 테마",value:"강한 미래는 누군가의 가능성을 앗아간다"}]),pn=Object.freeze([{title:"미래를 자원처럼 쓰는 세계",text:"전투와 탐험, 정치가 모두 내일결 배분 구조와 연결된다."},{title:"상실을 전제로 한 성장",text:"강력한 힘은 기억, 관계, 현재 감각을 대가로 요구한다."},{title:"항해형 지역 구조",text:"도시와 던전이 조류와 시간대에 따라 다른 규칙을 가진다."}]),gn=Object.freeze([{era:"첫 역조",detail:"하늘과 바다의 경계가 뒤집히고 반향해가 생겨난다."},{era:"새벽종 시대",detail:"고대인들이 미래 배급 장치를 만들고 문명을 안정시킨다."},{era:"무월조 발발",detail:"내일결 생성이 멈추고 일부 지역에서 아침이 사라진다."},{era:"플레이어의 항해",detail:"종편 회수와 세계 질서 재구성의 선택이 시작된다."}]),g=Object.freeze([{id:"story-overview",title:"스토리 개요",category:"메인 설정",summary:"세계의 한 줄 콘셉트, 플레이어 역할, 메인 목표를 빠르게 파악하는 문서",fileName:"src/content/lore/story-overview.md",accent:"teal",content:Y},{id:"main-story",title:"메인 스토리",category:"메인 설정",summary:"프롤로그부터 엔딩 선택까지의 3막 구조와 핵심 반전을 정리한 문서",fileName:"src/content/lore/main-story.md",accent:"gold",content:$},{id:"core-systems",title:"코어 게임 시스템 설계",category:"시스템 설계",summary:"이동, 전투, 자원, 성장, 세이브, 실패 패널티를 포함한 실제 구현 기준의 코어 시스템 설계 문서",fileName:"src/content/game-design/00-core-systems.md",accent:"slate",content:W},{id:"prologue-playflow",title:"프롤로그 플레이 구성",category:"플레이 설계",summary:"프롤로그를 실제 구현 가능한 구간 단위로 재구성해 맵 흐름, 조사, 대화, 전투, 연출, UI 요구사항을 정리한 문서",fileName:"src/content/game-design/01-prologue-playflow.md",accent:"coral",content:q},{id:"ui-ux-guide",title:"게임 UX/UI 구성",category:"플레이 설계",summary:"탐험, 상호작용, 대화, 전투, 컷신, 메뉴 전환에 따라 HUD와 목표, 저장, 결과 화면을 어떻게 구성할지 정리한 문서",fileName:"src/content/game-design/02-ui-ux.md",accent:"plum",content:J},{id:"art-and-player-spec",title:"아트 기준 및 플레이어 스펙",category:"비주얼 설계",summary:"게임 로직 격자와 아트 캔버스를 분리하고, 캐릭터 픽셀 밀도·배경 레이어·애니메이션 프레임 기준까지 재정의한 고밀도 도트 아트 문서",fileName:"src/content/game-design/03-art-and-player-spec.md",accent:"teal",content:X},{id:"audio-scenario-plan",title:"시나리오 기반 BGM 설계안",category:"오디오 설계",summary:"챕터와 장면 감정선에 맞춘 핵심 BGM 8곡의 용도, 분위기, 배치 기준을 정리한 문서",fileName:"src/content/audio/00-scenario-bgm-plan.md",accent:"gold",content:rn},{id:"scenario-overview",title:"시나리오 개요",category:"시나리오 설계",summary:"메인 엔딩까지 약 8시간 기준의 챕터 수, 플레이타임, 대사 스크립트 작성 원칙을 정리한 문서",fileName:"src/content/scenario/00-overview.md",accent:"teal",content:V},{id:"scenario-prologue",title:"프롤로그",category:"챕터 시나리오",summary:"미라진에서 사라진 새벽을 목격하고 첫 항해를 시작하는 도입 챕터와 상세 대사 문서",fileName:"src/content/scenario/01-prologue.md",accent:"coral",content:Z},{id:"scenario-chapter-1",title:"챕터 1",category:"챕터 시나리오",summary:"유리염 사구에서 생존 갈등을 체감하고 첫 두 개의 종편을 회수하는 장면별 스크립트 문서",fileName:"src/content/scenario/02-chapter-1.md",accent:"gold",content:nn},{id:"scenario-chapter-2",title:"챕터 2",category:"챕터 시나리오",summary:"역항도 카델에서 유라 베인의 질서 논리와 두 개의 종편을 마주하는 장면별 스크립트 문서",fileName:"src/content/scenario/03-chapter-2.md",accent:"plum",content:en},{id:"scenario-chapter-3",title:"챕터 3",category:"챕터 시나리오",summary:"속삭임 과수원과 척추탑에서 진실과 플레이어 정체성을 드러내는 장면별 스크립트 문서",fileName:"src/content/scenario/04-chapter-3.md",accent:"slate",content:an},{id:"scenario-ending",title:"엔딩",category:"챕터 시나리오",summary:"침묵 산호궁 최종 던전과 세 가지 메인 엔딩 선택을 상세 스크립트로 정리한 문서",fileName:"src/content/scenario/05-ending.md",accent:"rose",content:tn},{id:"world-rules",title:"세계 규칙",category:"시스템 설정",summary:"반향해, 내일결, 시간 균열, 여명 인양사의 규칙을 정의한 문서",fileName:"src/content/lore/world-rules.md",accent:"coral",content:sn},{id:"regions",title:"지역 설정",category:"세부 설정",summary:"항구, 사막, 역중력 도시, 최종 던전 등 탐험 지역의 성격을 정리한 문서",fileName:"src/content/lore/regions.md",accent:"plum",content:on},{id:"factions",title:"세력 설정",category:"세부 설정",summary:"조율원, 염해 길드, 공백 법정 등 주요 집단의 논리와 강약점을 정의한 문서",fileName:"src/content/lore/factions.md",accent:"slate",content:cn},{id:"characters",title:"인물 설정",category:"세부 설정",summary:"플레이어와 주요 인물의 역할, 감정선, 외형 디자인 포인트를 정리한 문서",fileName:"src/content/lore/characters.md",accent:"rose",content:ln}]),b=document.querySelector("#app");if(!b)throw new Error("앱 루트 요소를 찾을 수 없습니다.");const un=Object.freeze(["art-and-player-spec","characters","prologue-playflow","core-systems","scenario-prologue","scenario-overview","audio-scenario-plan"]),D=Object.freeze(un.map(e=>g.find(a=>a.id===e)).filter(Boolean));function f(e){return g.find(a=>a.id===e)}function C(){const e=decodeURIComponent(window.location.hash.replace(/^#/,""));return f(e)?e:""}function mn(e){const a=`#${e}`;window.location.hash!==a&&window.history.replaceState(null,"",a)}function An(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function u(e){return An(e).replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>")}function hn(e){const a=e.trim().split(/\r?\n/),r=[];let n=[],t=[],s="ul",o=[];const i=()=>{n.length&&(r.push(`<p>${n.map(u).join("<br />")}</p>`),n=[])},d=()=>{if(!t.length)return;const A=t.map(l=>`<li>${u(l)}</li>`).join("");r.push(`<${s}>${A}</${s}>`),t=[],s="ul"},p=()=>{o.length&&(r.push(`<blockquote><p>${o.map(u).join("<br />")}</p></blockquote>`),o=[])};for(const A of a){const l=A.trimEnd(),h=l.match(/^(#{1,3})\s+(.*)$/),v=l.match(/^-\s+(.*)$/),x=l.match(/^\d+\.\s+(.*)$/),w=l.match(/^>\s?(.*)$/);if(!l.trim()){i(),d(),p();continue}if(l==="---"){i(),d(),p(),r.push("<hr />");continue}if(h){i(),d(),p();const I=h[1].length;r.push(`<h${I}>${u(h[2])}</h${I}>`);continue}if(v){i(),p(),s!=="ul"&&t.length&&d(),s="ul",t.push(v[1]);continue}if(x){i(),p(),s!=="ol"&&t.length&&d(),s="ol",t.push(x[1]);continue}if(w){i(),d(),o.push(w[1]);continue}n.push(l)}return i(),d(),p(),r.join("")}function Pn(e,a){const r=document.querySelector("[data-document-nav]");r&&(r.innerHTML=g.map(n=>`
        <button
          type="button"
      ...
      `).join(""),r.querySelectorAll("[data-document-trigger]").forEach(n=>{n.addEventListener("click",()=>{a(n.getAttribute("data-document-trigger")||e)})}))}function yn(e,a){const r=document.querySelector("[data-featured-links]");r&&(r.innerHTML=D.map(n=>`
        <button
          type="button"
      ...
      `).join(""),r.querySelectorAll("[data-featured-trigger]").forEach(n=>{n.addEventListener("click",()=>{a(n.getAttribute("data-featured-trigger")||e)})}))}function fn(e){const a=f(e)??g[0],r=document.querySelector("[data-document-viewer]");!r||!a||(r.innerHTML=`
    <div class="viewer-meta">
      <span class="viewer-meta__badge viewer-meta__badge--${a.accent}">${a.category}</span>
      <span class="viewer-meta__file">${a.fileName}</span>
    </div>
    <header class="viewer-header">
      <h2>${a.title}</h2>
      <p>${a.summary}</p>
    </header>
    <article class="markdown-body">${hn(a.content)}</article>
  `,xn(a.id,r))}function vn(e){const a=c.palette.map(t=>`
        <li class="art-palette__item">
          <span class="art-palette__swatch" style="--swatch:${t.hex}"></span>
          <span>
            <strong>${t.name}</strong>
            <span>${t.hex} · ${t.role}</span>
          </span>
        </li>
      `).join(""),r=c.poseOptions.map(t=>`
        <figure class="art-card">
          <img src="${t.image}" alt="${t.label} 플레이어 정지 기본 포즈" loading="lazy" />
          <figcaption>
            <strong>${t.label}</strong>
            <p>${t.note}</p>
          </figcaption>
        </figure>
      `).join(""),n=c.deliverables.map(t=>`
      ...
      <section class="art-review" aria-label="프롤로그 플레이어 아트 결과물">
        ...
        <div class="art-review__meta">
          <div>
            <strong>${c.decision.selectedLabel}</strong>
            <span>${c.decision.canvas}</span>
          </div>
          <div>
            <strong>검수 범위</strong>
            <span>${c.decision.review}</span>
          </div>
        </div>

        <ul class="art-review__notes">
          ${c.rationale.map(t=>`<li>${t}</li>`).join("")}
        </ul>
        ...
        <div class="art-review__section">
          ...
          <div class="art-grid art-grid--options">${r}</div>
        </div>
        ...
        <div class="art-review__section">
          ...
          <div class="art-grid art-grid--deliverables">${n}</div>
        </div>
        ...
        <div class="art-review__section">
          ...
          <ul class="art-palette">${a}</ul>
        </div>
      </section>
    `)}function xn(e,a){e==="art-and-player-spec"&&vn(a)}function wn(){return{activeTrackId:m[0]?.id??"",isPlaying:!1}}function y(e){return m.find(a=>a.id===e)}function B(e){const a=document.querySelector("[data-soundtrack-player]"),r=document.querySelector("[data-soundtrack-element]"),n=y(e.activeTrackId)??m[0];!a||!r||!n||(a.innerHTML=`
  ...
  `,r.setAttribute("aria-label",`${n.koreanTitle} 재생기`))}function U(e){const a=document.querySelector("[data-soundtrack-list]");a&&(a.innerHTML=m.map(r=>`
        <article class="audio-card audio-card--${r.accent}${r.id===e.activeTrackId?" is-active":""}">
          ...
          <dl class="audio-card__details">
            ...
            <div>
              <dt>주요 악기</dt>
              <dd>${r.instrumentation}</dd>
            </div>
          </dl>
          <div class="audio-card__actions">
            <button type="button" class="audio-card__button" data-audio-toggle="${r.id}">
              ${r.id===e.activeTrackId&&e.isPlaying?"일시정지":"재생"}
            </button>
            <a class="audio-card__link" href="${r.src}" download>
              파일 받기
            </a>
          </div>
        </article>
      `).join(""))}function In(){b.innerHTML=`
    <div class="page-shell">
      <header class="hero">
        <div class="hero__content">
          <p class="eyebrow">Issue #80 · Prologue Player Art</p>
          <h1>${P.title}</h1>
          <p class="hero__subtitle">${P.subtitle}</p>
          <p class="hero__pitch">${P.pitch}</p>
        </div>
  ...
  `}function Cn(){let e=C()||D[0]?.id||g[0]?.id||"";const a=wn(),r=(s,{syncHash:o=!0}={})=>{e=f(s)?.id??e,yn(e,r),Pn(e,r),fn(e),o&&mn(e)};In();const n=document.querySelector("[data-soundtrack-element]");r(e),B(a),U(a);const t=()=>{B(a),U(a),document.querySelectorAll("[data-audio-toggle]").forEach(s=>{s.addEventListener("click",async()=>{const o=s.getAttribute("data-audio-toggle"),i=y(o);if(!(!n||!i))if(a.activeTrackId!==i.id&&(n.src=i.src,n.dataset.trackId=i.id,a.activeTrackId=i.id),n.paused)try{await n.play()}catch{a.isPlaying=!1,t()}else if(n.dataset.trackId===i.id)n.pause();else{n.pause(),n.src=i.src,n.dataset.trackId=i.id;try{await n.play()}catch{a.isPlaying=!1,t()}}})})};if(n){const s=y(a.activeTrackId);s&&(n.src=s.src,n.dataset.trackId=s.id),n.addEventListener("play",()=>{a.isPlaying=!0,a.activeTrackId=n.dataset.trackId||a.activeTrackId,t()}),n.addEventListener("pause",()=>{a.isPlaying=!1,t()}),n.addEventListener("ended",()=>{a.isPlaying=!1,t()})}t(),window.addEventListener("hashchange",()=>{const s=C();s&&s!==e&&r(s,{syncHash:!1})})}Cn();
