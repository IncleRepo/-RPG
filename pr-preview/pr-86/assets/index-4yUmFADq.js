...
- 고정 레퍼런스 파일: \`assets/art-reference/base-dot-design-reference.png\`
- 이 이미지는 특정 캐릭터 확정안이 아니라 \`베이스 도트디자인\` 기준 샘플로 사용한다.
- 앞으로 LLM이 캐릭터 도트를 생성할 때는 이 파일의 렌더링 언어와 가독성 기준을 먼저 따른다.
- 실제 캐릭터 정체성은 \`src/content/lore/characters.md\`의 외형 설정을 우선 반영한다.
- 즉, \`도트 표현 방식\`은 이 레퍼런스를 따르고 \`머리색/의상/장비/인상\`은 캐릭터 설정에 맞게 바꾼다.

### 이 레퍼런스에서 따라야 할 요소

- 작은 크기에서도 얼굴 중심이 먼저 읽히는 머리-얼굴-목선 구조
- 눈, 앞머리, 피부 영역이 분리되는 얼굴 가독성
- 굵고 안정적인 외곽선과 내부 덩어리 중심의 클러스터 셰이딩
- 상체, 하체, 외투, 가방끈, 소지품이 분리되는 실루엣 설계
- 어두운 외곽선 + 중간톤 + 밝은 하이라이트가 분명한 명암 구조
- 작은 악센트 소품으로 시선을 잡아 주는 구성

### 이 레퍼런스에서 그대로 복제하면 안 되는 요소
...
- 먼저 이 레퍼런스의 \`비율\`, \`얼굴 가독성\`, \`덩어리 셰이딩\`, \`외곽선 처리\`를 따른다.
- 그 위에 캐릭터 설정 문서의 외형 요소를 덮어쓴다.
- 결과물이 레퍼런스와 비슷한 캐릭터가 되면 실패로 본다.
- 결과물이 레퍼런스와 비슷한 \`퀄리티 언어\`를 가지면 성공으로 본다.
...
`,E=Object.freeze({title:`반향해 연대기`,subtitle:`내일이 결정으로 떠오르는 세계에서, 사라진 새벽을 추적하는 해양 판타지 RPG 설정집`,pitch:`플레이어는 미래의 잔향을 들을 수 있는 여명 인양사가 되어, 도시 국가와 고대 장치가 얽힌 세계에서 내일의 소유권을 둘러싼 전쟁을 마주한다.`,setting:`반향해 기반 해양 판타지`,mood:`몽환적 서정성과 시간 재난`,coreConflict:`미래를 통제할 것인가, 모두에게 되돌릴 것인가`}),D=Object.freeze([{label:`세계 키워드`,value:`반향해, 내일결, 새벽종`},{label:`플레이어 역할`,value:`미래 반향을 듣는 여명 인양사`},{label:`메인 목표`,value:`일곱 개의 새벽 종편 회수`},{label:`메인 플레이타임`,value:`약 8시간`},{label:`문서 구성`,value:`시나리오 6종 + 설정/설계 10종 + BGM 설계 1종`},{label:`서사 테마`,value:`강한 미래는 누군가의 가능성을 앗아간다`}]),O=Object.freeze([{title:`미래를 자원처럼 쓰는 세계`,text:`전투와 탐험, 정치가 모두 내일결 배분 구조와 연결된다.`},{title:`상실을 전제로 한 성장`,text:`강력한 힘은 기억, 관계, 현재 감각을 대가로 요구한다.`},{title:`항해형 지역 구조`,text:`도시와 던전이 조류와 시간대에 따라 다른 규칙을 가진다.`}]),k=Object.freeze([{era:`첫 역조`,detail:`하늘과 바다의 경계가 뒤집히고 반향해가 생겨난다.`},{era:`새벽종 시대`,detail:`고대인들이 미래 배급 장치를 만들고 문명을 안정시킨다.`},{era:`무월조 발발`,detail:`내일결 생성이 멈추고 일부 지역에서 아침이 사라진다.`},{era:`플레이어의 항해`,detail:`종편 회수와 세계 질서 재구성의 선택이 시작된다.`}]),A=Object.freeze([{id:`story-overview`,title:`스토리 개요`,category:`메인 설정`,summary:`세계의 한 줄 콘셉트, 플레이어 역할, 메인 목표를 빠르게 파악하는 문서`,fileName:`src/content/lore/story-overview.md`,accent:`teal`,content:l},{id:`main-story`,title:`메인 스토리`,category:`메인 설정`,summary:`프롤로그부터 엔딩 선택까지의 3막 구조와 핵심 반전을 정리한 문서`,fileName:`src/content/lore/main-story.md`,accent:`gold`,content:u},{id:`core-systems`,title:`코어 게임 시스템 설계`,category:`시스템 설계`,summary:`이동, 전투, 자원, 성장, 세이브, 실패 패널티를 포함한 실제 구현 기준의 코어 시스템 설계 문서`,fileName:`src/content/game-design/00-core-systems.md`,accent:`slate`,content:d},{id:`prologue-playflow`,title:`프롤로그 플레이 구성`,category:`플레이 설계`,summary:`프롤로그를 실제 구현 가능한 구간 단위로 재구성해 맵 흐름, 조사, 대화, 전투, 연출, UI 요구사항을 정리한 문서`,fileName:`src/content/game-design/01-prologue-playflow.md`,accent:`coral`,content:f},{id:`ui-ux-guide`,title:`게임 UX/UI 구성`,category:`플레이 설계`,summary:`탐험, 상호작용, 대화, 전투, 컷신, 메뉴 전환에 따라 HUD와 목표, 저장, 결과 화면을 어떻게 구성할지 정리한 문서`,fileName:`src/content/game-design/02-ui-ux.md`,accent:`plum`,content:p},{id:`art-and-player-spec`,title:`아트 기준 및 플레이어 스펙`,category:`비주얼 설계`,summary:`게임 로직 격자와 아트 캔버스를 분리하고, 캐릭터 픽셀 밀도·배경 레이어·애니메이션 프레임 기준까지 재정의한 고밀도 도트 아트 문서`,fileName:`src/content/game-design/03-art-and-player-spec.md`,accent:`teal`,content:m},{id:`audio-scenario-plan`,title:`시나리오 기반 BGM 설계안`,category:`오디오 설계`,summary:`챕터와 장면 감정선에 맞춘 핵심 BGM 8곡의 용도, 분위기, 배치 기준을 정리한 문서`,fileName:`src/content/audio/00-scenario-bgm-plan.md`,accent:`gold`,content:x},{id:`scenario-overview`,title:`시나리오 개요`,category:`시나리오 설계`,summary:`메인 엔딩까지 약 8시간 기준의 챕터 수, 플레이타임, 대사 스크립트 작성 원칙을 정리한 문서`,fileName:`src/content/scenario/00-overview.md`,accent:`teal`,content:h},{id:`scenario-prologue`,title:`프롤로그`,category:`챕터 시나리오`,summary:`미라진에서 사라진 새벽을 목격하고 첫 항해를 시작하는 도입 챕터와 상세 대사 문서`,fileName:`src/content/scenario/01-prologue.md`,accent:`coral`,content:g},{id:`scenario-chapter-1`,title:`챕터 1`,category:`챕터 시나리오`,summary:`유리염 사구에서 생존 갈등을 체감하고 첫 두 개의 종편을 회수하는 장면별 스크립트 문서`,fileName:`src/content/scenario/02-chapter-1.md`,accent:`gold`,content:_},{id:`scenario-chapter-2`,title:`챕터 2`,category:`챕터 시나리오`,summary:`역항도 카델에서 유라 베인의 질서 논리와 두 개의 종편을 마주하는 장면별 스크립트 문서`,fileName:`src/content/scenario/03-chapter-2.md`,accent:`plum`,content:v},{id:`scenario-chapter-3`,title:`챕터 3`,category:`챕터 시나리오`,summary:`속삭임 과수원과 척추탑에서 진실과 플레이어 정체성을 드러내는 장면별 스크립트 문서`,fileName:`src/content/scenario/04-chapter-3.md`,accent:`slate`,content:y},{id:`scenario-ending`,title:`엔딩`,category:`챕터 시나리오`,summary:`침묵 산호궁 최종 던전과 세 가지 메인 엔딩 선택을 상세 스크립트로 정리한 문서`,fileName:`src/content/scenario/05-ending.md`,accent:`rose`,content:b},{id:`world-rules`,title:`세계 규칙`,category:`시스템 설정`,summary:`반향해, 내일결, 시간 균열, 여명 인양사의 규칙을 정의한 문서`,fileName:`src/content/lore/world-rules.md`,accent:`coral`,content:S},{id:`regions`,title:`지역 설정`,category:`세부 설정`,summary:`항구, 사막, 역중력 도시, 최종 던전 등 탐험 지역의 성격을 정리한 문서`,fileName:`src/content/lore/regions.md`,accent:`plum`,content:C},{id:`factions`,title:`세력 설정`,category:`세부 설정`,summary:`조율원, 염해 길드, 공백 법정 등 주요 집단의 논리와 강약점을 정의한 문서`,fileName:`src/content/lore/factions.md`,accent:`slate`,content:w},{id:`characters`,title:`인물 설정`,category:`세부 설정`,summary:`플레이어와 주요 인물의 역할, 감정선, 외형 디자인 포인트를 정리한 문서`,fileName:`src/content/lore/characters.md`,accent:`rose`,content:T}]),j=document.querySelector(`#app`);if(!j)throw Error(`앱 루트 요소를 찾을 수 없습니다.`);var M=Object.freeze([`core-systems`,`audio-scenario-plan`,`scenario-overview`,`scenario-prologue`,`scenario-chapter-1`,`scenario-chapter-2`,`scenario-chapter-3`,`scenario-ending`,`characters`]),N=Object.freeze(M.map(e=>A.find(t=>t.id===e)).filter(Boolean));function P(e){return A.find(t=>t.id===e)}function F(){let e=decodeURIComponent(window.location.hash.replace(/^#/,``));return P(e)?e:``}function I(e){let t=`#${e}`;window.location.hash!==t&&window.history.replaceState(null,``,t)}function L(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function R(e){return L(e).replace(/`([^`]+)`/g,`<code>$1</code>`).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`)}function z(e){let t=e.trim().split(/\r?\n/),n=[],r=[],i=[],a=`ul`,o=[],s=()=>{r.length&&(n.push(`<p>${r.map(R).join(`<br />`)}</p>`),r=[])},c=()=>{if(!i.length)return;let e=i.map(e=>`<li>${R(e)}</li>`).join(``);n.push(`<${a}>${e}</${a}>`),i=[],a=`ul`},l=()=>{o.length&&(n.push(`<blockquote><p>${o.map(R).join(`<br />`)}</p></blockquote>`),o=[])};for(let e of t){let t=e.trimEnd(),u=t.match(/^(#{1,3})\s+(.*)$/),d=t.match(/^-\s+(.*)$/),f=t.match(/^\d+\.\s+(.*)$/),p=t.match(/^>\s?(.*)$/);if(!t.trim()){s(),c(),l();continue}if(t===`---`){s(),c(),l(),n.push(`<hr />`);continue}if(u){s(),c(),l();let e=u[1].length;n.push(`<h${e}>${R(u[2])}</h${e}>`);continue}if(d){s(),l(),a!==`ul`&&i.length&&c(),a=`ul`,i.push(d[1]);continue}if(f){s(),l(),a!==`ol`&&i.length&&c(),a=`ol`,i.push(f[1]);continue}if(p){s(),c(),o.push(p[1]);continue}r.push(t)}return s(),c(),l(),n.join(``)}function B(e,t){let n=document.querySelector(`[data-document-nav]`);n&&(n.innerHTML=A.map(t=>`
        <button
          type="button"
          class="document-card${t.id===e?` is-active`:``}"
      ...
      `).join(``),n.querySelectorAll(`[data-document-trigger]`).forEach(n=>{n.addEventListener(`click`,()=>{t(n.getAttribute(`data-document-trigger`)||e)})}))}function V(e,t){let n=document.querySelector(`[data-featured-links]`);n&&(n.innerHTML=N.map(t=>`
        <button
          type="button"
          class="spotlight-card spotlight-card--${t.accent}${t.id===e?` is-active`:``}"
      ...
      `).join(``),n.querySelectorAll(`[data-featured-trigger]`).forEach(n=>{n.addEventListener(`click`,()=>{t(n.getAttribute(`data-featured-trigger`)||e)})}))}function H(e){let t=P(e)??A[0],n=document.querySelector(`[data-document-viewer]`);!n||!t||(n.innerHTML=`
    ...
    <article class="markdown-body">${z(t.content)}</article>
  `)}function U(){return{activeTrackId:c[0]?.id??``,isPlaying:!1}}function W(e){return c.find(t=>t.id===e)}function G(e){let t=document.querySelector(`[data-soundtrack-player]`),n=document.querySelector(`[data-soundtrack-element]`),r=W(e.activeTrackId)??c[0];!t||!n||!r||(t.innerHTML=`
    ...
    <div class="soundtrack-player__status">
      <span class="viewer-meta__badge viewer-meta__badge--${r.accent}">
        ${e.isPlaying?`재생 중`:`준비됨`}
      </span>
      <span class="viewer-meta__file">${r.fileName}</span>
    </div>
  `,n.setAttribute(`aria-label`,`${r.koreanTitle} 재생기`))}function K(e){let t=document.querySelector(`[data-soundtrack-list]`);t&&(t.innerHTML=c.map(t=>`
        <article class="audio-card audio-card--${t.accent}${t.id===e.activeTrackId?` is-active`:``}">
          ...
          <dl class="audio-card__details">
            ...
            <div>
              <dt>주요 악기</dt>
              <dd>${t.instrumentation}</dd>
            </div>
          </dl>
          <div class="audio-card__actions">
            <button type="button" class="audio-card__button" data-audio-toggle="${t.id}">
              ${t.id===e.activeTrackId&&e.isPlaying?`일시정지`:`재생`}
            </button>
            <a class="audio-card__link" href="${t.src}" download>
              파일 받기
            </a>
          </div>
        </article>
      `).join(``))}function q(){j.innerHTML=`
  ...
  `}function J(){let e=F()||N[0]?.id||A[0]?.id||``,t=U(),n=(t,{syncHash:r=!0}={})=>{e=P(t)?.id??e,V(e,n),B(e,n),H(e),r&&I(e)};q();let r=document.querySelector(`[data-soundtrack-element]`);n(e),G(t),K(t);let i=()=>{G(t),K(t),document.querySelectorAll(`[data-audio-toggle]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=W(e.getAttribute(`data-audio-toggle`));if(!(!r||!n))if(t.activeTrackId!==n.id&&(r.src=n.src,r.dataset.trackId=n.id,t.activeTrackId=n.id),r.paused)try{await r.play()}catch{t.isPlaying=!1,i()}else if(r.dataset.trackId===n.id)r.pause();else{r.pause(),r.src=n.src,r.dataset.trackId=n.id;try{await r.play()}catch{t.isPlaying=!1,i()}}})})};if(r){let e=W(t.activeTrackId);e&&(r.src=e.src,r.dataset.trackId=e.id),r.addEventListener(`play`,()=>{t.isPlaying=!0,t.activeTrackId=r.dataset.trackId||t.activeTrackId,i()}),r.addEventListener(`pause`,()=>{t.isPlaying=!1,i()}),r.addEventListener(`ended`,()=>{t.isPlaying=!1,i()})}i(),window.addEventListener(`hashchange`,()=>{let t=F();t&&t!==e&&n(t,{syncHash:!1})})}J();